...
/** Generated Model for WM_HandlingUnit
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_WM_HandlingUnit extends PO implements I_WM_HandlingUnit, I_Persistent 
{
    ...
    {
      super (ctx, WM_HandlingUnit_ID, trxName);
      /** if (WM_HandlingUnit_ID == 0)
        {
			setWM_HandlingUnit_ID (0);
        } */
    }

    /** Load Constructor */
    public X_WM_HandlingUnit (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_WM_HandlingUnit[")
