...
public class WM_EmptyStorageLineDocEvent extends AbstractEventHandler {
	...
	protected void initialize() { 
		registerTableEvent(IEventTopics.PO_AFTER_CHANGE, MWM_EmptyStorageLine.Table_Name);
	...
	log.info(" topic="+event.getTopic()+" po="+po);
		if (po instanceof MWM_EmptyStorageLine){
			if (IEventTopics.PO_AFTER_CHANGE == type){
				MWM_EmptyStorageLine modelpo = (MWM_EmptyStorageLine)po;
	log.fine("MWM_EmptyStorageLine changed: "+modelpo.get_ID());
	// **DO SOMETHING** ;
			}
		}
	  }
