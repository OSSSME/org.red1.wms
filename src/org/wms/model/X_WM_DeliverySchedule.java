...
public class X_WM_DeliverySchedule extends PO implements I_WM_DeliverySchedule, I_Persistent 
{
    ...
    {
      super (ctx, WM_DeliverySchedule_ID, trxName);
      /** if (WM_DeliverySchedule_ID == 0)
        {
			setWM_DeliverySchedule_ID (0);
        } */
    }

    /** Load Constructor */
    public X_WM_DeliverySchedule (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_WM_DeliverySchedule[")
	...
	{
		return (String)get_Value(COLUMNNAME_PrintDate);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_TripNo);
	}
    ...
    {
		return (I_WM_Truck)MTable.get(getCtx(), I_WM_Truck.Table_Name)
			.getPO(getWM_Truck_ID(), get_TrxName());	}

	/** Set Truck.
		@param WM_Truck_ID Truck	  */
	public void setWM_Truck_ID (int WM_Truck_ID)
	{
		if (WM_Truck_ID < 1) 
			set_Value (COLUMNNAME_WM_Truck_ID, null);
		else 
			set_Value (COLUMNNAME_WM_Truck_ID, Integer.valueOf(WM_Truck_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_WM_Truck_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
